...
public final class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENU_TYPES =
            DeferredRegister.create(ForgeRegistries.MENU_TYPES, AE2LightningTech.MODID);
    ...
    public static final RegistryObject<MenuType<TeslaCoilMenu>> TESLA_COIL = MENU_TYPES.register(
            "tesla_coil",
            () -> TeslaCoilMenu.TYPE);
    ...
    public static final RegistryObject<MenuType<FrequencyMenu>> FREQUENCY_MENU = MENU_TYPES.register(
            "frequency_menu",
            () -> FrequencyMenu.TYPE);
