 ...
 * has not yet been initialized. Mutating methods throw
 * {@link IllegalStateException} in that window.
 */
public final class FrequencyApi {
    ...
    public static FrequencyBindingAccess createBinding(FrequencyBindingHost host) {
        var p = provider;
        if (p == null) {
            throw new IllegalStateException("FrequencyApi provider not yet initialized");
        }
