 ...
 * and names, and the saved-data key ({@code "FrequencyId"}) used by
 * {@link com.moakiee.ae2lt.api.frequency.FrequencyBindingAccess#save(net.minecraft.world.level.storage.ValueOutput)} /
 * {@link com.moakiee.ae2lt.api.frequency.FrequencyBindingAccess#load(net.minecraft.world.level.storage.ValueInput)}.
 *
