 ...
 * <ul>
 *   <li>extend {@link AENetworkedBlockEntity} so a main grid node can be connected,</li>
 ...
 *       saveAdditional / loadTag / serverTick / main-node state change) to the
 *       access object.</li>
 * </ul>
 */
public interface FrequencyBindingHost {
    ...
    /** Persist pending saved-data changes; typically {@code setChanged()} on the BE. */
