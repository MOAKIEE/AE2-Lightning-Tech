...
public final class LightningAssemblyLockedRecipe {
    ...
    @Nullable
    public static LightningAssemblyLockedRecipe fromInput(ValueInput data) {
        ...
        int lightningCost = data.getInt(TAG_LIGHTNING_COST)
                .orElseGet(() -> data.getIntOr(TAG_LEGACY_DUST_COST, 0) > 0
                        ? LightningAssemblyRecipe.DEFAULT_LIGHTNING_COST
                        : 0);
        LightningKey.Tier lightningTier = LightningKey.Tier.fromSerializedName(
                data.getStringOr(
                        TAG_LIGHTNING_TIER,
                        LightningAssemblyRecipe.DEFAULT_LIGHTNING_TIER.getSerializedName()));
        return createOrNull(
    ...
    @Nullable
    private static LightningAssemblyLockedRecipe createOrNull(
            String recipeId,
            ItemStack result,
            long totalEnergy,
            int lightningCost,
