...
public class OverloadProcessingFactoryBlockEntity extends AENetworkedBlockEntity
    ...
    public void saveAdditional(ValueOutput data) {
        ...
        inputTank.serialize(data.child(TAG_INPUT_TANK));
        outputTank.serialize(data.child(TAG_OUTPUT_TANK));
    ...
    public void loadTag(ValueInput data) {
        ...
        inputTank.deserialize(data.childOrEmpty(TAG_INPUT_TANK));
        outputTank.deserialize(data.childOrEmpty(TAG_OUTPUT_TANK));
        ...
        lockedRecipe = data.child(TAG_LOCKED_RECIPE)
                .map(OverloadProcessingLockedRecipe::fromInput)
                .orElse(null);
        if (lockedRecipe == null) {
            consumedEnergy = 0L;
