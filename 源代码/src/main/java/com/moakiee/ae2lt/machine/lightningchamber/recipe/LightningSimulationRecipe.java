...
public final class LightningSimulationRecipe implements Recipe<LightningSimulationRecipeInput> {
    ...
    public static final class Serializer implements RecipeSerializer<LightningSimulationRecipe> {
        ...
        private static void writeToBuf(FriendlyByteBuf buf, LightningSimulationRecipe recipe) {
        ...
        private static LightningSimulationRecipe readFromBuf(FriendlyByteBuf buf) {
            int priority = buf.readVarInt();
            int inputSize = buf.readVarInt();
            List<LightningSimulationIngredient> inputs = new ArrayList<>(inputSize);
