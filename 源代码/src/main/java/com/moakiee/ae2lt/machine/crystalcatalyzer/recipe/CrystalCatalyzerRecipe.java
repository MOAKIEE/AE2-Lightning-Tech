...
public final class CrystalCatalyzerRecipe implements Recipe<CrystalCatalyzerRecipeInput> {
    ...
    public static final class Serializer implements RecipeSerializer<CrystalCatalyzerRecipe> {
        ...
        private static void writeToBuf(FriendlyByteBuf buf, CrystalCatalyzerRecipe recipe) {
        ...
        private static CrystalCatalyzerRecipe readFromBuf(FriendlyByteBuf buf) {
            boolean hasCatalyst = buf.readBoolean();
            Optional<Ingredient> catalyst = hasCatalyst ? Optional.of(Ingredient.of(buf.readItem())) : Optional.empty();
